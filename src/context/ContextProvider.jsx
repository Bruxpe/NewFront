...
const URL_PATIENTS = `https://apideploy-production.up.railway.app/patients`;
const URL_DOCTORS = `https://apideploy-production.up.railway.app/doctors`;
const URL_SPECIALTIES = `https://apideploy-production.up.railway.app/specialties`;
const URL_SOCIALSECURITY = `https://apideploy-production.up.railway.app/socialSecurity`;
const URL_PERFILMEDICO = `https://apideploy-production.up.railway.app/perfilMedico`;
const URL_TURNOS = `https://apideploy-production.up.railway.app/appointments`;
